...
// src/animations.js
var exports_animations = {};
__export(exports_animations, {
  fadeIn: () => fadeIn
});
gsapWithCSS.defaults({
  ease: "power2.out"
});
function fadeIn(el, opts = {}, pos = "") {
  gsapWithCSS.to(el, {
    y: "0%",
    opacity: 1,
    duration: 0.5,
...
// src/main.js
var COLOR_PRIMARY = "#009473FF";
var COLOR_PRIMARY_TRANSPARENT = "#00947300";
document.addEventListener("DOMContentLoaded", () => {
  ...
  function handleTopIntersection(ents) {
    ...
    if (ent.isIntersecting) {
      ...
      gsapWithCSS.to(header, { y: "0%", background: COLOR_PRIMARY_TRANSPARENT });
      gsapWithCSS.set(header, { position: "absolute", y: "-100%" });
    } else {
      header.setAttribute("data-at-top", 0);
      gsapWithCSS.set(header, { position: "fixed", y: "-100%" });
      gsapWithCSS.to(header, { y: "0%", background: COLOR_PRIMARY });
    }
  }
  handleNavigationClicks();
  function handleMenuToggle() {
    const tl = gsapWithCSS.timeline({ defaults: { duration: 0.35, ease: "power2.inOut" } });
...
function handleNavigationClicks() {
  ...
  for (const anchor of navAnchorEls) {
    anchor.addEventListener("click", () => {
      ...
      closeMenu(gsapWithCSS.timeline({ defaults: { duration: 0.35, ease: "power2.inOut" } }));
    });
  }
}
function openMenu(tl) {
  document.getElementById("menu").setAttribute("data-mobile-state", "open");
  tl.add("start").to("#menu", { y: "3rem" }).to('[data-menu-animate="hor"', { x: "0%", opacity: 1, stagger: 0.1, duration: 0.4 }, "<50%").to('[data-menu-animate="ver"', { y: "0%", opacity: 1, duration: 0.4 }, "<").to('[data-toggler-line="2"]', {
    width: "0%"
  }, 0).set('[data-toggler-line]:not([data-toggler-line="2"])', {
    position: "absolute",
    y: "-50%",
    x: "-50%",
    top: "50%",
...
function closeMenu(tl) {
  ...
  tl.to("#menu", {
    y: "-100%"
  }).to('[data-menu-animate="hor"', { x: "100%", opacity: 0 }).to('[data-menu-animate="ver"', { y: "100%", opacity: 0 }).to('[data-toggler-line="2"]', {
    width: "1.25rem"
  }, "0+=50%").set('[data-toggler-line]:not([data-toggler-line="2"])', {
    position: "relative",
    y: "",
    x: "",
    top: "",
